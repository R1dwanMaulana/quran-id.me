    ...
    <HeaderNav />
      <div class="pt-16">
        ...
        <div v-for="verse in surah.data.verses" :key="verse" class="bg-gray-900 border border-transparent py-5 px-4 rounded-xl m-4 text-right">
          ...
          <div class="text-left">
              <div @click="clickShowTafsir(verse.tafsir)" class="focus:outline-none font-normal inline-flex items-center py-2">
              ...
              <div @click="clickShow(verse.text.arab)" class="focus:outline-none font-normal inline-flex items-center py-2">
                ...
                <img :src="toogleIcon2" @click="icon2 = !icon2" alt="">
              </div>
...
export default {
  ...
  computed: {
    toogleIcon() {
      if(this.icon) {
        return require('/static/arrow-up.svg')
      } else {
        return require('/static/arrow-down.svg')
      }
    },
    toogleIcon2() {
      if(this.icon2) {
